...
/**
 * RegistryDirectory
 * Directory的动态列表实现，会自动从注册中心更新Invoker，列表，配置信息，路由列表
 *
 * 有两条比较重要的逻辑线：
...
public class RegistryDirectory<T> extends AbstractDirectory<T> implements NotifyListener {
    ...
    /**
     * 监听到配置中心对应的URL变化，然后更新本地的配置参数。
     * 监听的URL分为三类：配置configureators,路由规则router,Invoker列表
     *
     *
    ...
    /**
     * 1.检查服务是否被禁用
     * 2.根据方法名和首参数匹配Invoker
     * 3.根据方法名匹配Invoker
     * 4.根据"*"匹配Invoker
     * 5.遍历methodInvokerMap,找到第一个Invoker列表返回
     * @param invocation
     * @return
     */
    @Override
