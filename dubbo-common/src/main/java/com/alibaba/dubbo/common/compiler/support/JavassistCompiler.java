 ...
 * java中动态生成class的方式很多，可以直接基于字节码的方式生成。常见的工具有CGLIB,ASM,Javassist等。
 * 而自适应扩展点使用了生成字符串再编译为class的方法。
 */
public class JavassistCompiler extends AbstractCompiler {
    ...
    /**
     * 1.初始化Javassist,设置默认参数，比如设置当前的classpath
     ...
     * 5.通过正则匹配出类里面所有内容，即得到{}中的内容，再通过正则匹配出所有方法，并使用javassist添加类的方法
     * 6.生成class对象。
     * @param name
     * @param source
     * @return
